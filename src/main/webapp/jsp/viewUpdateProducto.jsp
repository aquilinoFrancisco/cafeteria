...
<center>
	<h2>
		<spring:message code="label.titulo2" />
	</h2>
</center>

<form:form method="post" action="updateProducto.html"
	...
	<div class="form-group">
		...
		<textarea class="form-control" id="precioUnitarioProducto"
			name="precioUnitarioProducto" rows="2" value="${producto.precioUnitarioProducto}"
	...
	<div class="form-group">
		...
		<textarea class="form-control" id="estatus"
			name="estatus" rows="2" value="${producto.estatus}"
